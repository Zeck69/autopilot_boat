...
- The ***keel*** might be the most precious ally for balance. Especially when the mast is high and heavy, the keel plays the role of a counterweight creating a moment that prevent the boat from tilting on the side.
...
To put parts together, we used epoxy glue for all the components. This method surprisingly proved its efficiency during our tests. This glue is also well suited for water (epoxy is used for real boats).  
